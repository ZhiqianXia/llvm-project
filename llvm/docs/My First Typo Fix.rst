...
.. code:: console
   ...
   **/path/test.cc:1:124:** **warning****: in order to understand recursion, you must first understand recursion [-Winfinite-recursion]**
...
.. code:: console
   ...
   $ ninja ToolingTests && tools/clang/unittests/Tooling/ToolingTests --gtest_filter=ReplacementText.CanDeleteAllText
...
another email any time the review is updated.
...
-  rebase your patch against the latest LLVM code. LLVM uses a linear
   history, so everything should be based on an up-to-date
   origin/master.
...
see your change `on
GitHub <https://github.com/llvm/llvm-project/commits/master>`__ within
minutes.
